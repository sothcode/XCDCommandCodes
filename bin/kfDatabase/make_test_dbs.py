...
kf.writeVar(testparameters,"DEBUG_PH/lowbound","0.1","new")
kf.writeVar(testparameters,"DEBUG_PH/highbound","0.7","new")
...
kf.writeVar(testparameters,"DEBUG_AT/lowbound","0.1","new")
kf.writeVar(testparameters,"DEBUG_AT/highbound","0.7","new")
