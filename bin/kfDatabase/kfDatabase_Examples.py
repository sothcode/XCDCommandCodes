...
print("####To get a list of the current VariableDictionary: listVar(\"dbName\")")
listVar("VariableDictionary.txt")
#Prints a list of the values and returns True

#-------------------

print("####To read a value from VariableDictionary: readVar(\"dbName\",\"variableName\")")
readVar("VariableDictionary.txt","one")
#Prints the value of the variable given, and returns True and the value 

print("####If the variable name is not in the list, gives an error message and returns False")
readVar("VariableDictionary.txt","wrongName")

print("####If no arguments are given, argument info is printed and returns False")
readVar("VariableDictionary.txt")

#--------------------

print("####To write a value to a variable: writeVar(\"dbName\",\"variableName\", variable value)")
...
print("####If only a variable name is given and not a value, error message is printed and returns False")
writeVar("VariableDictionary.txt","one")

print("####If the variable given is not recognized, error message is printed and returns False")
writeVar("VariableDictionary.txt","wrongName", 99)

print("####To add a new variable name and value to the dictionary, add \"new\" as a 3rd argument and returns True")
writeVar("VariableDictionary.txt","newVariable", 77, "new")
print("####If \"new\" is added but the variable name is already in the list, a new variable will NOT be added; the existing one will be updated")
writeVar("VariableDictionary.txt","existingVariable", 66, "new")

print("####If no arguments given, argument info is printed and returns False")
writeVar()
